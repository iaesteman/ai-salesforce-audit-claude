...
SKILLS=(
  ...
  "sf-audit-orphaned:skills/sf-audit-orphaned/SKILL.md"
...
echo -e "  ${CYAN}/sf-audit naming [org]${NC}       Naming convention enforcement"
echo -e "  ${CYAN}/sf-audit orphaned [org]${NC}     Orphaned & inactive metadata"
